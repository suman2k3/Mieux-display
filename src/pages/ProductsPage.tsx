...
export function ProductsPage() {
  ...
  return (
    <div className="bg-[#050505] text-[#F5F5F5] min-h-screen">
          ...
          <div className="grid gap-8 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-6">
              <Reveal>
                ...
                <p className="mt-4 text-base sm:text-lg text-[#A1A1AA] leading-relaxed max-w-xl">
            ...
            {/* Right Column: Hero Image Container (6 cols) */}
            <div className="lg:col-span-6 relative flex flex-col lg:items-end z-10 hover:z-50">
              <Reveal delay={0.15} className="w-full lg:max-w-[94%] ml-auto">
                ...
                >
                  <div className="relative h-[290px] sm:h-[340px] lg:h-[380px] w-full overflow-hidden rounded-[24px] border border-[#E4E4E7] bg-white shadow-2xl p-4 sm:p-6 flex flex-col justify-between">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        <Link to={`/products/${currentHeroSlide.slug}`} className="block h-full w-full relative group/img flex flex-col justify-between p-1">
                          <div className="h-[200px] sm:h-[240px] lg:h-[270px] w-full flex items-center justify-center bg-white overflow-hidden rounded-xl">
                            <img
                          ...
                          <div className="mt-2 pt-2 border-t border-[#E4E4E7] flex items-center justify-between">
                            ...
                            <span className="inline-flex items-center gap-1.5 text-xs font-bold text-[#9B1B9E] group-hover/img:text-[#B52CB8]">
                    ...
                    <div className="absolute top-4 right-4 z-20 flex items-center gap-2">
                      <button
                        ...
                        className="grid h-9 w-9 place-items-center rounded-full border border-[#E4E4E7] bg-white text-[#0D0D0F] shadow-sm transition-all hover:border-[#9B1B9E] hover:bg-[#9B1B9E] hover:text-white"
                      >
                ...
                <div className="mt-3 flex items-center justify-between px-1 text-xs text-[#A1A1AA] font-medium">
                  <div className="flex items-center gap-2 overflow-x-auto max-w-[80%] no-scrollbar">
      ...
      {/* ─────────────────────────────────────────────── */}
      <section id="product-catalog" className="bg-[#F7F7F5] text-[#0D0D0F] py-14 lg:py-20 border-b border-[#E4E4E7] relative z-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Product Cards Grid — PURE WHITE THEME + FIT ALL IMAGES IN FRAME */}
              ...
              {filteredProducts.map((p, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {/* PURE WHITE PRODUCT CARD — DYNAMIC HEIGHT, NO CUT-OFF TEXT */}
                      <div className="relative flex flex-col justify-between overflow-hidden rounded-[24px] border border-[#E4E4E7] bg-white shadow-md transition-all duration-300 group-hover:border-[#9B1B9E] group-hover:shadow-2xl h-full min-h-[410px] sm:min-h-[430px] w-full">
                        
                        {/* Top Image Frame Box — Compact height so text has 100% breathing room */}
                        <div className="relative h-[175px] sm:h-[185px] w-full overflow-hidden bg-[#F8F9FA] border-b border-[#E4E4E7] flex items-center justify-center p-3.5 shrink-0">
                          <img
                            src={p.image}
                            alt={p.name}
                            loading="lazy"
                        ...
                        {/* Bottom White Information Section — Ample spacing for all text lines & CTA */}
                        <div className="relative z-10 p-4.5 sm:p-5 flex flex-col justify-between flex-1 bg-white">
                          <div className="space-y-1.5">
                            {/* Eyebrow Tagline */}
                            <span className="text-[10px] font-extrabold uppercase tracking-[0.16em] text-[#9B1B9E] block leading-tight">
                              {tagline}
                            </span>
                      ...
                      {/* HOVER STATE OVERLAY — HIDES TEXT & SHOWS ENLARGED PRODUCT IMAGE ONLY */}
                      <div className="absolute inset-0 z-30 rounded-[24px] border-2 border-[#9B1B9E] bg-white shadow-[0_25px_60px_rgba(155,27,158,0.3)] opacity-0 transition-all duration-300 ease-out group-hover:opacity-100 pointer-events-none flex flex-col items-center justify-center p-6 overflow-hidden">
                        <img
                          src={p.image}
                          alt={p.name}
      ...
      {/* ─────────────────────────────────────────────── */}
      <section className="relative overflow-hidden bg-[#050505] py-16 lg:py-24 border-b border-[#27272A] text-[#F5F5F5]">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
          <div className="grid gap-10 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-6">
              <Reveal>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  <Link
                    to="/catalogue"
                    className="inline-flex items-center gap-2 rounded-xl bg-[#9B1B9E] px-7 py-3.5 text-xs font-bold text-white shadow-lg transition-all duration-300 hover:bg-[#B52CB8] hover:-translate-y-0.5 group"
                  >
                  ...
                  <Link
                    to="/contact"
                    className="inline-flex items-center gap-2 rounded-xl border border-[#27272A] bg-[#151518] px-6 py-3.5 text-xs font-semibold text-[#A1A1AA] backdrop-blur transition-all duration-300 hover:border-[#9B1B9E] hover:text-white"
                  >
            ...
            {/* Right Column: Curated Product Image Collage (6 cols) */}
            <div className="lg:col-span-6 relative">
              <Reveal delay={0.15}>
                <div className="relative mx-auto max-w-md lg:max-w-none">
                  ...
                  <div className="relative aspect-[16/11] w-full overflow-hidden rounded-[24px] border border-[#27272A] bg-[#151518] p-4 sm:p-5 shadow-[0_20px_50px_rgba(0,0,0,0.8)] transition-all duration-500 hover:border-[#9B1B9E]/60 group">
                    <div className="relative h-full w-full overflow-hidden rounded-[16px] bg-white border border-[#E4E4E7] flex items-center justify-center p-4">
                      <img
                        src={img.heroIfp}
                      ...
                      {/* Badge overlay */}
                      <span className="absolute bottom-3 left-3 rounded-full bg-[#050505]/90 border border-[#27272A] px-3 py-1 text-[10px] font-extrabold text-[#9B1B9E] backdrop-blur shadow-md">
                        Interactive & Commercial Displays
                      </span>
                    </div>
                  </div>

                  {/* Secondary Overlapping Product Card (Bottom Right Stacked) */}
                  <div className="absolute -bottom-5 -right-2 sm:-right-4 w-[55%] sm:w-[50%] aspect-[4/3] rounded-[20px] border border-[#27272A] bg-[#151518] p-2.5 sm:p-3 shadow-[0_20px_50px_rgba(155,27,158,0.25)] transition-all duration-500 hover:border-[#9B1B9E] hover:scale-[1.03] hidden sm:block">
                  ...
                  {/* Tertiary Overlapping Badge Card (Top Left Floating) */}
                  <div className="absolute -top-4 -left-2 sm:-left-4 rounded-2xl border border-[#27272A] bg-[#050505]/90 px-4 py-2.5 shadow-xl backdrop-blur hidden sm:flex items-center gap-2 text-xs font-bold text-white">
      ...
      <section className="bg-[#050505] py-14 lg:py-20 text-[#F5F5F5] border-b border-[#27272A] relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
          <div className="grid gap-8 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              <Reveal>
                <div className="relative overflow-hidden rounded-[24px] border border-[#27272A] shadow-2xl aspect-[16/10] bg-[#151518]">
                  <img
                    src={img.indoorLed}
            ...
            <div className="lg:col-span-6 space-y-5">
              <Reveal delay={0.1}>
                ...
                <h2 className="mt-2.5 font-display text-3xl sm:text-4xl font-extrabold text-white leading-tight">
                  Designed for <span className="text-[#9B1B9E]">Every Environment</span>
                </h2>
                <p className="mt-3 text-xs sm:text-sm text-[#A1A1AA] leading-relaxed font-medium">
