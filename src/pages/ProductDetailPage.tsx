...
export function ProductDetailPage() {
  ...
  return (
    <div className="bg-[#050505] text-[#F5F5F5] antialiased min-h-screen">
      ...
      {/* ───────────────────────────────────────────────────────── */}
      <section className="relative isolate overflow-hidden bg-[#050505] py-12 lg:py-20 text-[#F5F5F5] border-b border-[#27272A]">
            ...
            <div className="lg:col-span-6 relative">
              <Reveal>
                <div className="relative">
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl border border-[#E4E4E7] bg-white shadow-2xl flex items-center justify-center p-4 sm:p-6">
                    <img
                      src={selectedImage}
                      alt={product.name}
                    ...
                    {galleryThumbnails.map((thumb, idx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative h-16 w-24 shrink-0 overflow-hidden rounded-xl border bg-white p-1.5 transition-all duration-200 ${
                            isSelected
            ...
            <div className="lg:col-span-6">
              <Reveal delay={0.1}>
                <div>
                  ...
                  <h1 className="mt-2.5 font-display text-3xl font-extrabold sm:text-4xl lg:text-5xl text-white tracking-tight">
                    {product.name}
                  </h1>
                  <p className="mt-1.5 font-display text-base font-bold text-[#9B1B9E] sm:text-lg">
                    {product.subtitle}
                  </p>

                  <p className="mt-4 text-xs sm:text-sm leading-relaxed text-[#A1A1AA] font-medium">
                    {product.description}
                  </p>

                  {/* 2x3 Specification Feature Grid */}
                  <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Layers className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">16-Bit</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Grayscale</span>
                    </div>

                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Zap className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">&lt;2ms</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Ultra Low Latency</span>
                    </div>

                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Activity className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">{product.quickSpecs.refreshRate || "3840Hz"}</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Refresh Rate</span>
                    </div>

                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Wrench className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">{product.quickSpecs.service || "Front & Rear"}</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Maintenance</span>
                    </div>

                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Eye className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">160°</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Wide Viewing Angle</span>
                    </div>

                    <div className="rounded-xl border border-[#27272A] bg-[#151518] p-3.5">
                      <Maximize2 className="h-4 w-4 text-[#9B1B9E] mb-1" />
                      <span className="block font-display text-sm font-bold text-white">Seamless</span>
                      <span className="text-[11px] font-medium text-[#A1A1AA]">Perfect Alignment</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 flex flex-wrap items-center gap-4">
                    <Link
                      to="/contact"
                      className="inline-flex items-center gap-2 rounded-xl bg-[#9B1B9E] px-7 py-3.5 text-xs sm:text-sm font-bold text-white shadow-md transition-all hover:bg-[#B52CB8] hover:-translate-y-0.5"
                    >
                      Request a Quote <ArrowRight className="h-4 w-4" />
                    </Link>
                    <button
                      onClick={() => setOtpOpen(true)}
                      className="inline-flex items-center gap-2 rounded-xl border border-[#27272A] bg-[#151518] px-7 py-3.5 text-xs sm:text-sm font-semibold text-white backdrop-blur transition-colors hover:border-[#9B1B9E] hover:bg-[#1D1D21]"
                    >
      ...
      <section className="bg-[#0D0D0F] border-b border-[#27272A] py-6 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="rounded-2xl border border-[#27272A] bg-[#151518] p-4 sm:p-5 shadow-xl">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 divide-y sm:divide-y-0 sm:divide-x divide-[#27272A] text-center">
              <div className="pt-2 sm:pt-0">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">Pixel Pitch</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
                  {product.quickSpecs.pixelPitch || "P0.9 – P1.2"}
                </span>
              </div>

              <div className="pt-2 sm:pt-0 sm:pl-3">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">Brightness</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
              ...
              <div className="pt-2 sm:pt-0 lg:pl-3">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">Refresh Rate</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
              ...
              <div className="pt-2 sm:pt-0 lg:pl-3">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">Contrast Ratio</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
                  10,000 : 1
                </span>
              </div>
              ...
              <div className="pt-2 sm:pt-0 lg:pl-3">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">Cabinet Weight</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
                  5.2 kg / cabinet
                </span>
              </div>
              ...
              <div className="pt-2 sm:pt-0 lg:pl-3">
                <span className="block text-[11px] font-bold uppercase tracking-wider text-[#FF6B00]">IP Rating</span>
                <span className="font-display text-sm font-extrabold text-white mt-1 block">
                  IP40 / IP30
                </span>
              </div>
      ...
      <section className="bg-[#050505] text-[#F5F5F5] py-14 lg:py-20 border-b border-[#27272A]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-10 text-center max-w-2xl mx-auto">
            ...
            <h2 className="mt-2.5 font-display text-3xl font-extrabold text-white sm:text-4xl tracking-tight">
              Full Specifications
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-8 overflow-hidden rounded-3xl border border-[#27272A] bg-[#151518] shadow-2xl p-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                {/* Column 1 */}
                <div className="divide-y divide-[#27272A]">
                  {specsLeft.map((spec) => (
                    <div key={spec.label} className="py-3 flex flex-col sm:flex-row sm:items-center justify-between text-xs">
                      <span className="font-semibold text-white">{spec.label}</span>
                      <span className="text-[#A1A1AA] font-medium mt-0.5 sm:mt-0 text-right">{spec.value}</span>
                    </div>
                  ))}
                </div>
            ...
            <div className="lg:col-span-4 flex">
              <div className="relative overflow-hidden rounded-3xl border border-[#27272A] bg-[#151518] shadow-2xl w-full flex flex-col justify-end p-6 aspect-[4/5]">
                <img
                  src={img.controlRoom}
                ...
                <div className="relative z-10 text-white">
                  ...
                  <p className="mt-1.5 text-xs text-[#A1A1AA] leading-relaxed font-medium">
      ...
      {/* ───────────────────────────────────────────────────────── */}
      <section className="bg-[#F5F5F5] text-[#0D0D0F] py-14 lg:py-20 border-b border-[#E4E4E7]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
              ...
              <Reveal key={app.title} delay={idx * 0.05}>
                ...
                >
                  ...
                  <div>
                    ...
                    <h3 className="mt-0.5 font-display text-base font-bold text-[#0D0D0F] group-hover:text-[#9B1B9E] transition-colors">
                      {app.title}
                    </h3>
      ...
      <section className="bg-[#050505] text-[#F5F5F5] py-14 lg:py-20 border-b border-[#27272A]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {relatedProducts.map((p, idx) => (
              <Reveal key={p.id} delay={idx * 0.05}>
                <Link
                  to={`/products/${p.slug}`}
                  className="group flex flex-col justify-between overflow-hidden rounded-[20px] border border-[#27272A] bg-[#151518] p-3.5 shadow-2xl transition-all duration-300 hover:-translate-y-1.5 hover:border-[#9B1B9E]"
                >
                  <div>
                    ...
                    <h3 className="mt-0.5 font-display text-base font-bold text-white group-hover:text-[#9B1B9E] transition-colors">
                      {p.name}
                    </h3>
          ...
          <div className="mt-12 text-center border-t border-[#27272A] pt-8">
      ...
      {/* ───────────────────────────────────────────────────────── */}
      <section className="relative isolate overflow-hidden bg-[#050505] py-16 sm:py-24 text-[#F5F5F5] border-b border-[#27272A]">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 z-10">
          <Reveal>
            ...
            <h2 className="mt-2 font-display text-3xl font-extrabold text-white sm:text-4xl lg:text-5xl tracking-tight">
              Looking for the right display solution?
            </h2>
            <p className="mx-auto mt-4 max-w-2xl text-xs sm:text-sm text-[#A1A1AA] leading-relaxed font-medium">
