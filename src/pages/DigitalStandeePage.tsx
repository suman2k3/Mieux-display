...
export function DigitalStandeePage() {
  ...
  return (
    <div className="bg-[#050505] text-[#F5F5F5] antialiased min-h-screen selection:bg-[#9B1B9E] selection:text-white">
              ...
              <Reveal>
                ...
                <div className="mt-8 sm:mt-10 border-t border-[#27272A] pt-5 flex flex-wrap gap-4 sm:gap-6 text-xs font-semibold text-[#A1A1AA]">
                  <span className="flex items-center gap-1.5 text-white">
                    <CheckCircle2 className="h-4 w-4 text-[#9B1B9E] shrink-0" /> 4K Ultra HD IPS Panel
                  </span>
                  <span className="flex items-center gap-1.5 text-white">
                    <CheckCircle2 className="h-4 w-4 text-[#FF6B00] shrink-0" /> 24/7 Commercial Rating
                  </span>
                  <span className="flex items-center gap-1.5 text-white">
                    <CheckCircle2 className="h-4 w-4 text-[#9B1B9E] shrink-0" /> Plug & Play / Cloud CMS
                  </span>
                </div>
              </Reveal>
            </div>
      ...
      <section className="bg-[#F7F7F5] text-[#0D0D0F] py-10 sm:py-14 lg:py-16 border-b border-[#E4E4E7]">
