  ...
  return (
    <div className="bg-[#050505] text-[#F5F5F5] antialiased min-h-screen selection:bg-[#9B1B9E] selection:text-white">
      ...
      <section className="relative isolate overflow-hidden bg-[#050505] text-white py-12 sm:py-18 lg:py-24 border-b border-[#27272A]">
        ...
        <div className="mx-auto max-w-7xl 2xl:max-w-[1536px] px-4 sm:px-6 lg:px-8 relative z-10 text-center sm:text-left">
          <Reveal>
            <span className="inline-flex items-center gap-2 rounded-full border border-[#27272A] bg-[#151518] px-3.5 py-1.5 text-[11px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#FF6B00] backdrop-blur-md mb-3">
              MIEUX DISPLAY • EVENTS & EXPERIENCES
            </span>
            <h1 className="font-display text-3xl xs:text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl font-extrabold tracking-tight text-white leading-[1.1]">
              Where MIEUX <span className="text-[#9B1B9E]">Comes to Life</span>
            </h1>
            <p className="mt-3 sm:mt-4 max-w-2xl text-xs sm:text-base text-[#A1A1AA] lg:text-lg leading-relaxed font-medium">
      ...
      <section className="sticky top-[56px] sm:top-[64px] lg:top-[72px] z-40 border-b border-[#27272A] bg-[#050505]/95 backdrop-blur-md py-3 sm:py-3.5 shadow-2xl text-white">
        <div className="mx-auto max-w-7xl 2xl:max-w-[1536px] px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2.5 overflow-x-auto no-scrollbar py-0.5 -mx-4 px-4 sm:mx-0 sm:px-0">
      ...
      <section className="bg-[#F7F7F5] text-[#0D0D0F] py-12 sm:py-16 lg:py-20 border-b border-[#E4E4E7]">
        <div className="mx-auto max-w-7xl 2xl:max-w-[1536px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 sm:gap-6 mb-6 sm:mb-10">
            <div>
              ...
              <h2 className="mt-2 font-display text-2xl xs:text-3xl sm:text-4xl font-extrabold text-[#0D0D0F] tracking-tight">
                Moments Worth <span className="text-[#9B1B9E]">Remembering</span>
              </h2>
              <p className="mt-1 text-xs sm:text-sm text-[#52525B] max-w-xl font-medium">
            ...
            <div className="hidden sm:flex items-center gap-2 shrink-0">
              <button
                ...
                className="grid h-10 w-10 place-items-center rounded-full border border-[#E4E4E7] bg-white text-[#0D0D0F] shadow-sm transition-all hover:border-[#9B1B9E] hover:text-[#9B1B9E] cursor-pointer"
              >
        ...
        >
          <div className="flex w-max gap-3.5 sm:gap-5 px-4 sm:px-6 lg:px-8 xl:px-12">
            {featuredMoments.map((item, idx) => (
              <Reveal key={`${item.eventId}-${idx}`} delay={idx * 0.04}>
                <div
                  ...
                  className="group relative flex flex-col justify-between overflow-hidden rounded-[18px] sm:rounded-[20px] border border-[#E4E4E7] bg-white p-3 sm:p-3.5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#9B1B9E] hover:shadow-xl cursor-pointer w-[240px] xs:w-[270px] sm:w-[310px] lg:w-[330px] shrink-0"
                >
                  <div className="relative aspect-[16/10] w-full overflow-hidden rounded-xl bg-slate-100 mb-2.5 sm:mb-3">
                    <img
                      src={item.photo.url}
                  ...
                  <div>
                    <span className="text-[10px] font-bold uppercase tracking-wider text-[#FF6B00] truncate block">
                      {item.eventTitle}
                    </span>
                    <p className="mt-0.5 text-xs text-[#52525B] line-clamp-1 font-medium">
                      {item.photo.alt}
                    </p>
                  </div>

                  <div className="mt-2.5 sm:mt-3 flex items-center justify-between text-xs font-bold text-[#9B1B9E] border-t border-[#E4E4E7] pt-2 sm:pt-2.5">
      ...
      {lightboxState.isOpen && lightboxState.eventId && (
        <GalleryLightbox
          ...
          eventTitle={allPublishedEvents.find((e) => e.id === lightboxState.eventId)?.title}
        />
      )}
    </div>
  );
