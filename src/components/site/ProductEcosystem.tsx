...
export function ProductEcosystem() {
  ...
  // Subtle auto-scroll pause on hover
  useEffect(() => {
    if (isHovered) return;
  ...
  return (
    <section className="relative bg-[#050505] text-[#F5F5F5] py-16 lg:py-24 overflow-x-clip border-b border-[#27272A]">
      ...
      {/* LARGE PORTRAIT IMAGE CAROUSEL TRACK (4 CARDS VISIBLE + ~15-20% PARTIAL NEXT CARD ON DESKTOP) */}
      <div
        ref={scrollRef}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* FLOATING ENLARGED POP-OUT PREVIEW (POPS OUTSIDE CARD BOUNDARIES ON HOVER ON DESKTOP, UNDER HEADER) */}
